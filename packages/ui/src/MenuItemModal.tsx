  ...
  return (
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={[
          styles.modalContent,
          isKidsMode && styles.kidsModalContent
        ]}>
          <TouchableOpacity 
            style={[
              styles.closeButton,
              isKidsMode && styles.kidsCloseButton
            ]} 
            onPress={onClose}
          >
            <MaterialIcons 
          ...
          <ScrollView style={styles.scrollContent}>
            <View style={styles.header}>
              <View style={[
                ...
                isKidsMode && styles.kidsGallerySection
              ]}>
            ...
            <View style={[
              ...
              isKidsMode && styles.kidsDetailsContainer
            ]}>
              <Text style={[
                styles.name,
                isKidsMode && styles.kidsName
              ]}>
              ...
              {menuItem.sizes && menuItem.sizes.length > 0 && (
                <View style={[
                  styles.sizeSection,
                  isKidsMode && styles.kidsSizeSection
                ]}>
                  <Text style={[
                    styles.sectionTitle,
                  ...
                  <View style={styles.ingredients}>
                    {menuItem.keyIngredients.map((ingredient, index) => (
                      <View 
                        ...
                        style={[
                          styles.ingredient,
                          isKidsMode && styles.kidsIngredient
                        ]}
                      >
                        <View style={[
                          styles.ingredientIcon,
                          isKidsMode && styles.kidsIngredientIcon
                        ]}>
                          <FontAwesome6 
                            name={ingredient.icon} 
                            size={24} 
                            color={isKidsMode ? "#ff7622" : "#FF8C00"} 
                          />
                        </View>
                        <Text style={[
                          styles.ingredientText,
                          isKidsMode && styles.kidsIngredientText
                        ]}>
                          {ingredient.name}
                        </Text>
                      </View>
            ...
            {showAddButton && (
              ...
              >
                <Text style={[
                  ...
                  isKidsMode && styles.kidsAddButtonText
                ]}>
