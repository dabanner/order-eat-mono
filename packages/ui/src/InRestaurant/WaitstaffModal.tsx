...
import type { WaitstaffRequest } from "@repo/store/src/commandStore"
...
export const WaitstaffModal: React.FC<WaitstaffModalProps> = ({ visible, onClose, onAction, mode }) => {
  ...
  const getModalContent = () => {
    switch (selectedAction) {
      ...
      case "other":
        return {
          image:
            "https://media.istockphoto.com/id/1440553933/fr/vectoriel/illustration-vectorielle-de-beaux-serveurs-sc%C3%A8ne-de-dessin-anim%C3%A9-avec-des-serveurs-hommes.jpg?s=612x612&w=0&k=20&c=koAeVczxGXzcH4WvQJPWOy0i1D7XgVrdimcRD2YQ1JM=",
    ...
    <>
      ...
      >
        <View style={styles.modalButtons}>
          ...
          <TouchableOpacity style={[styles.modalButton, styles.waterButton]} onPress={() => handleAction("water")}>
            <MaterialCommunityIcons name="water" size={24} color="#fff" />
            <Text style={styles.modalButtonText}>Add Water</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.modalButton, styles.otherButton]} onPress={() => handleAction("other")}>
